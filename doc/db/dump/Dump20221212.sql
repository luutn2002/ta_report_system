...
INSERT INTO `account` VALUES (1,1,'m5251201','111',0),(2,1,'m5261202','222',0),(3,1,'s1270141','333',0),(4,2,'s100','444',0),(5,3,'f100','555',0);
...
INSERT INTO `assistant_course` VALUES (1,1,1,0);
...
INSERT INTO `record` VALUES (1,1,1,'2022-11-01','09:00:00','10:40:00','00:00:00','01:40:00',0),(2,1,1,'2022-11-02','13:20:00','15:00:00','00:00:00','01:40:00',0),(3,1,4,'2022-11-08','13:00:00','16:00:00','00:30:00','02:30:00',0),(4,2,2,'2022-11-05','09:00:00','10:40:00','00:00:00','01:40:00',0),(5,2,3,'2022-11-02','09:00:00','10:40:00','00:00:00','01:40:00',0);
...
CREATE TABLE `report` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `assistant_cource_id_UNIQUE` (`assistant_course_id`),
  ...
  CONSTRAINT `ibfk_report_assistant_course_id_assistant_courses_id` FOREIGN KEY (`assistant_course_id`) REFERENCES `assistant_course` (`id`),
...
INSERT INTO `report` VALUES (1,1,1,2022,'2022-11-01','04:10:00','120:00:00',0,NULL,NULL,0,NULL,NULL,1,'2022-11-21',0),(2,2,2,2022,'2022-11-01','12:05:25','120:00:00',1,1,'2022-12-03',1,1,'2022-12-01',5,'2022-12-03',0);
...
-- Dump completed on 2022-12-12 17:31:03
